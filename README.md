...
Курсовая работа по дисциплине "Технологии сетевого взаимодействия" (9-й семестр) 
...
1. Отображение данных в таблицах:
	1. Реализовать интерфейс для просмотра полного списка всех "Событий" (бронирований) в системе.
	2. Реализовать таблицу-справочник "Ресурсы", показывающую все доступные для бронирования комнаты и оборудование.

2.	Фильтрация данных:
	1. В таблице бронирований должна быть реализована фильтрация по дате (показать все бронирования на сегодня).
	2. Реализовать фильтрацию по ресурсу (показать расписание для "Переговорной №1").
	3. Реализовать фильтрацию по сотруднику (показать "мои" бронирования).

3.	Объединение и вывод сводных данных:
	1. Реализовать сводную таблицу "Календарь занятости". Таблица должна выводить данные в формате: "Название Ресурса", "Дата", "Время начала", "Время окончания", "ФИО сотрудника" (кто забронировал).
	2. Реализовать сводный отчет "Загрузка ресурсов": "Название Ресурса", "Общее количество часов бронирования" за последний месяц (агрегация).
